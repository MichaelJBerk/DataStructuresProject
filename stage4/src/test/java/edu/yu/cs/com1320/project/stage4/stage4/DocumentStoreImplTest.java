package edu.yu.cs.com1320.project.stage4.stage4;
...
public class DocumentStoreImplTest {
    ...
    public void testPutPdfDocumentNoPreviousDocAtURI(){
        ...
        assertTrue(returned == this.pdfTxt1.hashCode());
    }
    ...
    public void testPutTxtDocumentNoPreviousDocAtURI(){
        ...
        assertTrue(returned == this.txt1.hashCode());
    }
    ...
    public void testGetTxtDocAsPdf(){
        ...
        assertEquals(this.txt1, store.getDocumentAsTxt(uri1));
        assertTrue(returned == this.txt1.hashCode());
