package edu.yu.cs.com1320.project.stage5.othertests;
...
public class WordCountTest extends DocumentStoreTestHelpers {
    ...
    public void testDelete() {
        ...
        assertEquals(true, docExists(testStringNumber.STRING1));
        assertEquals(false, docExists(testStringNumber.STRING2));
    }
    ...
    public void testCommandSet() {
        ...
        putD3();
        ds.undo();
        assertEquals(false, docExists(testStringNumber.STRING3));
